...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900">
    ...
    <div class="relative z-10 p-6">
        <!-- Page Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-light text-white mb-2">Create New User</h1>
            ...
            <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8">
                ...
                <form method="POST" action="{{ route('admin.users.store') }}">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="password" class="block text-sm font-light text-gray-300 mb-2">Password *</label>
                                <input type="password" id="password" name="password" required
                                    class="w-full px-4 py-3 bg-gray-900/70 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-amber-500/50 transition">
                            </div>

                            <div>
                                <label for="password_confirmation" class="block text-sm font-light text-gray-300 mb-2">Confirm Password *</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-1">
                                ...
                                <textarea id="address" name="address" rows="3"
                                    class="w-full px-4 py-3 bg-gray-900/70 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-amber-500/50 transition">{{ old('address') }}</textarea>
                            </div>
                        </div>
                    </div>
